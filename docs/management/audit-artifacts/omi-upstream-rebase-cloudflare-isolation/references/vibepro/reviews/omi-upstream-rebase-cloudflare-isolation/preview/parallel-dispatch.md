...
- current_verification_summary_fingerprint: sha256:4453316a9067c54ac290717f14c1657f9191bc68b74942b16ab0a8f7a1824077
- verification_evidence_updated_at: 2026-08-03T08:21:55.555Z
- current_verification_evidence_updated_at: 2026-08-03T08:26:59.781Z
- preferred_order: -
...
- e2e: executed_at=2026-08-03T08:26:57.590Z git_recorded_at=2026-08-03T08:26:59.770Z
- integration: executed_at=2026-08-03T08:21:27.612Z git_recorded_at=2026-08-03T08:21:28.337Z
- unit: executed_at=2026-08-03T08:20:58.927Z git_recorded_at=2026-08-03T08:20:59.679Z
- typecheck: executed_at=2026-08-03T08:20:34.040Z git_recorded_at=2026-08-03T08:20:34.602Z
...
8. 他のAgent Review stageを同じbatchでdispatchしない。`vibepro review status . --id omi-upstream-rebase-cloudflare-isolation --stage preview` を実行し、その後 `vibepro pr prepare . --story-id omi-upstream-rebase-cloudflare-isolation --base <base-branch>` で次stageへ進む。
...
`vibepro review authorize . --id omi-upstream-rebase-cloudflare-isolation --stage preview --role human_usability --review-kind <preflight|final> --closes-risk "<risk>" --expected-judgment-delta "<decision this review can change>" --reusable-evidence <ref> --freeze <source,spec,test,review_surface>`

Lifecycle start command:
`vibepro review start . --id omi-upstream-rebase-cloudflare-isolation --stage preview --role human_usability --agent-system <codex|claude_code> --agent-id "<subagent-id>" --agent-thread-id "<subagent-thread-id>" --agent-session-id "<subagent-session-id>" --dispatch-authorization "<authorization-id>" --timeout-ms 600000`

timeout/replacement/manual shutdown用Lifecycle close command:
`vibepro review close . --id omi-upstream-rebase-cloudflare-isolation --stage preview --role human_usability --agent-id "<replacement-agent-id>" --close-reason manual_shutdown --close-evidence "<replacement-agent-close-evidence>"`
